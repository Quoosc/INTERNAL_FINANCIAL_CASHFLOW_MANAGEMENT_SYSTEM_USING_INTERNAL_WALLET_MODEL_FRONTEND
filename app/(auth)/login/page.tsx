...
// =============================================================
// Login Page — form email/password thật, gọi POST /api/v1/auth/login
// Role selector: UI-only, backend tự xác định role từ credentials.
// =============================================================
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center bg-slate-50 px-6 py-12">
        <div className="w-full max-w-md">
          ...
          {/* ── Role Selector (UI only — backend xác định role từ credentials) ── */}
          <div className="mb-6">
