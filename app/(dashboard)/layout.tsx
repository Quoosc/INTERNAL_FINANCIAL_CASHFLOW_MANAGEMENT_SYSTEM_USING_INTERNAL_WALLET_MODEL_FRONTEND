...
function getNavGroups(role: RoleName | undefined): NavGroup[] {
  ...
  const notifications: NavItem = { label: "Thông báo", href: "/notifications", icon: icons.notifications };
      ...
      return [
        {
          ...
          items: [
            ...shared,
            { label: "Yêu cầu của tôi", href: "/requests",      icon: icons.requests },
    ...
    case RoleName.TEAM_LEADER:
      return [
        ...
        },
        {
          label: "Team Leader",
          items: [
            { label: "Duyệt yêu cầu",  href: "/team-leader/approvals", icon: icons.approvals },
            { label: "Dự án",           href: "/team-leader/projects",  icon: icons.projects },
            { label: "Nhóm của tôi",    href: "/team-leader/team",      icon: icons.team },
          ],
        },
        {
          label: "Cá nhân",
    ...
    case RoleName.MANAGER:
      return [
        ...
        },
        {
          label: "Manager",
          items: [
            { label: "Duyệt nạp quỹ DA", href: "/manager/approvals",   icon: icons.approvals },
            { label: "Dự án",             href: "/manager/projects",    icon: icons.projects },
            { label: "Phòng ban",         href: "/manager/department",  icon: icons.department },
          ],
        },
        {
          label: "Cá nhân",
    ...
    case RoleName.ACCOUNTANT:
      return [
        ...
        },
        {
          label: "Kế toán",
          items: [
            { label: "Giải ngân",     href: "/accountant/disbursements", icon: icons.disbursements },
            { label: "Bảng lương",    href: "/accountant/payroll",       icon: icons.payroll },
    ...
    <aside className="fixed left-0 top-0 h-full w-64 bg-slate-900 border-r border-white/5 flex flex-col z-50">
      ...
      <div className="p-5 border-b border-white/5">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-white font-bold text-sm truncate">IFMS Finance</h2>
      ...
      <div className="p-4 border-t border-white/5">
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={logout}
            className="text-slate-500 hover:text-rose-400 transition-colors p-1 flex-shrink-0"
            title="Đăng xuất"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
